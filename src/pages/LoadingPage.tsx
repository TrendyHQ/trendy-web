  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#242424] text-white p-4">
      <div className="w-full max-w-md mx-auto flex flex-col items-center space-y-8">
        {showBackButton && <div className="absolute top-4 left-4 sm:top-8 sm:left-8">
          <button
            onClick={() => navigate(-1)}
            aria-label="Go back"
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center">
          <div className="relative">
            ...
            <div className="relative bg-[#151515] rounded-full p-4">
              <Loader2 className="h-12 w-12 animate-spin text-[#ff5733]" />
            </div>
          </div>

          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight text-white">{message}</h1>
